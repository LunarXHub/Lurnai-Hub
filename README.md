  ...
  <table>
    <tr>
      <td align="center" width="400" style="background-color: #1a1a2e; border-radius: 10px; padding: 20px;">
        <img src="https://github.com/HVX-Havoc/Lurnai-Hub/blob/main/Github/muscle-legends.png" width="500" height="300" style="border-radius: 20px;" onerror="this.src='https://via.placeholder.com/100x100?text=Muscle+Legends'"/>
