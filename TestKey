...
MainSection:AddToggle("MainToggle", {
    Title = "Enable Feature",
    Description = "Toggle main functionality",
    Default = false,
...
MainSection:AddSlider("WalkSpeedSlider", {
    Title = "Walk Speed",
...
if SaveManager and InterfaceManager then
    ...
    InterfaceManager:BuildInterfaceSection(SettingsUI)
