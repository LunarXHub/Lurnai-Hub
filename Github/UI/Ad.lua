...
local mainColor = Color3.fromRGB(220, 70, 90)
local secondaryColor = Color3.fromRGB(20, 20, 20)
...
CopyButton.Position = UDim2.new(0.5, -75, 0, 90)
...
CloseButton.Position = UDim2.new(0.5, -75, 0, 150)
